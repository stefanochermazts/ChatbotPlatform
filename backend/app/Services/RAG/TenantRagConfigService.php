...
class TenantRagConfigService
{
    ...
    /**
     * ✅ NUOVO: Invalida manualmente la cache per un tenant
     * Utile quando si modificano campi del tenant che influenzano la configurazione RAG
     * (es: rag_profile, extra_intent_keywords, custom_synonyms)
     */
